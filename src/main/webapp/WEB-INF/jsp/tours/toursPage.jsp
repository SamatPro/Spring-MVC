            ...
            <div class="col-lg-7 ml-auto">
                <li class="menu__item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown3">
                        <a class="dropdown-item" href="/ordersPage?lang=Ru">${locale.get("russian-lang")}</a>
                        <a class="dropdown-item" href="/ordersPage?lang=En">${locale.get("english-lang")}</a>
                    </div>
                </li>
            ...
            <div class="card-deck mb-3 text-center">
                <div class="card mb-4 box-shadow">
                    <div class="card-header">
                        <h4 class="my-0 font-weight-normal"><c:out value="${city.name}"></c:out></h4>
                    </div>
                        ...
                        <div class="modal-body">
                            <form>
                                ...
                                <form class="form-search">
                                    ...
                                    <input type="text" class="input-medium search-query" name="searchField"id="searchf-coop${city.id}">
