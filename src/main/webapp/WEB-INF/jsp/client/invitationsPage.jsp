...
<section class="price">
    <div class="container">
        ...
        <div class="card-deck mb-3 text-center">
            <c:forEach var="coop" items="${coop}">
                <div class="card mb-4 box-shadow">
                    <div class="card-header">
                        <h4 class="my-0 font-weight-normal">${coop.order.city.name}</h4>
                    </div>
                    <div class="card-body">
                        <h1 class="card-title pricing-card-title">${coop.order.client.firstName} ${coop.order.client.lastName}</h1>
                        ...
                        <button type="button" class="btn btn-lg btn-block btn-outline-primary" onclick="consent(${coop.id}, true)">Принять</button>
                        <button type="button" class="btn btn-lg btn-block btn-outline-primary" onclick="consent(${coop.id}, false)">Удалить</button>
