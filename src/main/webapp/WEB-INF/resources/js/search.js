        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                for (let i = 0; i < data.length; i++) {
                    ...
                    contentTableHTML += "<td>   <button type=\"button\" class=\"btn btn-default btn-sm\" align='right' id='client"+data[i].id+"' onclick='addToBasket("+data[i].id+", this.id, "+")'>Выбрать</button>"+ "</td> ";
                    contentTableHTML += "</tr>";
